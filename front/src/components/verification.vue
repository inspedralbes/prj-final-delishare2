          ...
          <form @submit.prevent="sendRequest" class="space-y-6">
            <div>
              ...
              <textarea
                ...
                required
                class="w-full px-4 py-3 text-gray-700 bg-white border-2 border-lime-200 rounded-xl focus:outline-none focus:border-lime-400 focus:ring-2 focus:ring-lime-200 transition-all duration-300"
              ></textarea>
            </div>
