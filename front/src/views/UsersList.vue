  ...
  <div class="min-h-screen bg-lime-50 flex flex-col">
    ...
    <div class="w-full px-6 -mt-12 sm:-mt-8 relative z-20 flex justify-center items-center gap-4">
      <div class="w-full sm:w-2/3 md:w-1/2 lg:w-1/3 transform hover:scale-105 transition-transform duration-300">
        <div class="relative">
          <input type="text" v-model="searchTerm" placeholder="Cerca usuaris..."
          ...
          <table class="w-full">
            ...
            <tbody class="divide-y divide-lime-100">
              <tr v-for="user in filteredUsers" :key="user.id"
                class="hover:bg-lime-50/50 transition-colors duration-200">
                <td class="px-3 py-2">
                  <div class="flex items-center space-x-2">
                    <div class="flex-shrink-0">
                      <div
                        class="w-7 h-7 rounded-full bg-gradient-to-r from-lime-400 to-green-500 flex items-center justify-center text-white text-xs font-semibold">
...
export default {
  ...
  data() {
    return {
      ...
      showConfirmModal: false,  // Mostrar modal de confirmación
      userToDelete: null,       // ID del usuario a eliminar
  ...
  methods: {
    ...
    /**
     * Prepara la eliminación de un usuario mostrando el modal de confirmación
     ...
     * @param {Object} user - Usuario cuyo rol se va a actualizar
     */
