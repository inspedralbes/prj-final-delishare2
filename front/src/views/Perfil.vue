  ...
  <div class="profile-container">
    <div v-if="authStore.isAuthenticated">
      ...
      <div v-if="showCreateFolderInput"
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 transform transition-all duration-300" @click.stop>
          <div class="p-6">
            <div class="flex justify-between items-center mb-6">
              <h3 class="text-2xl font-bold text-lime-900">Crear Nueva Carpeta</h3>
              <button @click="showCreateFolderInput = false" class="text-gray-500 hover:text-gray-700 transition-colors">
      ...
      <!-- Menú de ajustes -->
      <div v-if="settingsMenuOpen" class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50" @click="toggleSettingsMenu">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 transform transition-all duration-300" @click.stop>
          <div class="p-6">
            <div class="flex justify-between items-center mb-6">
            ...
            <div class="space-y-2">
              <button @click="setActiveTab('image')" class="w-full flex items-center px-4 py-3 text-left text-gray-700 hover:bg-lime-50 rounded-xl transition-all duration-300">
              ...
              <button @click="setActiveTab('name')" class="w-full flex items-center px-4 py-3 text-left text-gray-700 hover:bg-lime-50 rounded-xl transition-all duration-300">
                <svg class="w-5 h-5 mr-3 text-lime-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                </svg>
                Canviar dades d'usuari
              </button>
              <button @click="setActiveTab('password')" class="w-full flex items-center px-4 py-3 text-left text-gray-700 hover:bg-lime-50 rounded-xl transition-all duration-300">
                <svg class="w-5 h-5 mr-3 text-lime-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button @click="goToFormulario" class="w-full flex items-center px-4 py-3 text-left text-gray-700 hover:bg-lime-50 rounded-xl transition-all duration-300">
                <svg class="w-5 h-5 mr-3 text-lime-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div v-if="isAdmin" class="mt-4">
                <button @click="goToAdmin" class="w-full flex items-center px-4 py-3 text-left text-white bg-gradient-to-r from-lime-600 to-green-600 hover:from-lime-700 hover:to-green-700 rounded-xl transition-all duration-300">
              ...
              <div v-if="!isChef && !isAdmin" class="mt-4">
                <button @click="goToVerification" class="w-full flex items-center px-4 py-3 text-left text-white bg-gradient-to-r from-green-500 to-lime-500 hover:from-green-600 hover:to-lime-600 rounded-xl transition-all duration-300">
                  <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div class="mt-4 pt-4 border-t border-gray-200">
                <button @click="confirmLogout('logOut')" class="w-full flex items-center px-4 py-3 text-left text-white bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 rounded-xl transition-all duration-300">
                  <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <!-- Confirmar logout -->
      <div v-if="showLogoutConfirmation" class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-6 transform transition-all duration-300">
          <div class="text-center">
            ...
            <div class="flex space-x-4">
              <button @click="logout" class="flex-1 px-4 py-2 bg-gradient-to-r from-red-500 to-red-600 text-white font-medium rounded-lg hover:from-red-600 hover:to-red-700 transition-all duration-300">
                Sí, cerrar sesión
              </button>
              <button @click="cancelLogout" class="flex-1 px-4 py-2 bg-gray-100 text-gray-700 font-medium rounded-lg hover:bg-gray-200 transition-all duration-300">
                Cancelar
              </button>
            </div>
          </div>
      ...
      <div v-if="activeTab === 'image'" class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl mx-4 p-6 transform transition-all duration-300">
          ...
          <div class="mt-6 flex justify-end">
            <button @click="cancelEdit" class="px-4 py-2 bg-gray-100 text-gray-700 font-medium rounded-lg hover:bg-gray-200 transition-all duration-300">
              Cancelar
            </button>
          </div>
        </div>
      ...
      <div v-if="activeTab === 'name'" class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-6 transform transition-all duration-300">
          <div class="flex justify-between items-center mb-6">
          ...
          <div class="mt-6 flex space-x-4">
            <button @click="updateProfile" class="flex-1 px-4 py-2 bg-gradient-to-r from-lime-500 to-green-500 text-white font-medium rounded-lg hover:from-lime-600 hover:to-green-600 transition-all duration-300">
              Guardar canvis
            </button>
            <button @click="cancelEdit" class="flex-1 px-4 py-2 bg-gray-100 text-gray-700 font-medium rounded-lg hover:bg-gray-200 transition-all duration-300">
              Cancelar
            </button>
          </div>
        </div>
      ...
      <div v-if="activeTab === 'password'" class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-6 transform transition-all duration-300">
          <div class="flex justify-between items-center mb-6">
          ...
          <div class="space-y-4">
            <div>
              <label for="currentPassword" class="block text-sm font-medium text-gray-700 mb-1">Contrasenya actual:</label>
              <div class="relative">
                <input :type="showCurrentPassword ? 'text' : 'password'" id="currentPassword" v-model="currentPassword"
                  class="w-full px-3 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-lime-500 transition-colors" />
                <button @click="togglePasswordVisibility('current')" class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700">
            ...
            <div>
              ...
              <div class="relative">
                <input :type="showNewPassword ? 'text' : 'password'" id="newPassword" v-model="newPassword"
                  class="w-full px-3 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-lime-500 transition-colors" />
                <button @click="togglePasswordVisibility('new')" class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700">
                  <img :src="showNewPassword ? eyeOpenIcon : eyeClosedIcon" class="w-5 h-5" />
                </button>
              </div>
            </div>
            <div>
              <label for="confirmPassword" class="block text-sm font-medium text-gray-700 mb-1">Confirmar nova contrasenya:</label>
              <div class="relative">
                <input :type="showConfirmPassword ? 'text' : 'password'" id="confirmPassword" v-model="confirmPassword"
                  class="w-full px-3 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-lime-500 transition-colors" />
                <button @click="togglePasswordVisibility('confirm')" class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700">
          ...
          <div class="mt-6 flex space-x-4">
            <button @click="updatePassword" class="flex-1 px-4 py-2 bg-gradient-to-r from-lime-500 to-green-500 text-white font-medium rounded-lg hover:from-lime-600 hover:to-green-600 transition-all duration-300">
              Guardar canvis
            </button>
            <button @click="cancelEdit" class="flex-1 px-4 py-2 bg-gray-100 text-gray-700 font-medium rounded-lg hover:bg-gray-200 transition-all duration-300">
              Cancelar
      ...
      <div v-if="showLiveForm"
        class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50"
        @click="toggleLiveForm">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 transform transition-all duration-300" @click.stop>
          <div class="p-6">
            <div class="flex justify-between items-center mb-6">
              <h3 class="text-2xl font-bold text-lime-900">Programar Nuevo Live</h3>
            ...
            <div class="space-y-4">
              <div class="form-group">
                <label for="recipe" class="block text-sm font-medium text-gray-700 mb-1">Receta:</label>
                <select id="recipe" v-model="newLive.recipe_id" required
                  class="w-full px-3 py-2 text-sm text-gray-700 bg-white border-2 border-lime-200 rounded-lg focus:outline-none focus:border-lime-400 focus:ring-2 focus:ring-lime-200 transition-all duration-300">
                  <option value="">Selecciona una receta</option>
                  <option v-for="recipe in recipes" :key="recipe.id" :value="recipe.id" class="py-1">{{ recipe.title }}
                  </option>
                </select>
              </div>
              <div class="form-group">
      ...
      <div v-if="showSavedSection" class="user-recipes saved-section">
        ...
        <div class="guardades-container">
          <div class="bg-white rounded-xl p-6 shadow-lg mb-8">
            ...
            <p class="text-gray-600 mb-4">Aquí encontrarás todas las recetas que has guardado para ti. Estas recetas son
              privadas y solo tú puedes verlas.</p>
          </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <div v-for="recipe in savedRecipes" :key="recipe.id"
                ...
                <div class="relative">
                  ...
                  <button @click="removeSavedRecipe(recipe.id)"
      ...
      <div v-if="showFoldersSection" class="user-recipes">
        ...
        <div v-else>
          <div class="bg-white rounded-xl p-6 shadow-lg mb-8">
            ...
            <p class="text-gray-600">Crea carpetas públicas para organizar y compartir tus recetas favoritas con otros
              usuarios. Estas carpetas serán visibles para todos.</p>
          </div>
